...
def generate_launch_description():
    ...
    spawn_node = Node(
        ...
        executable="create",
        arguments=[
            "-entity", "ev3_manipulator_mirror_sync",
    ...
    gazebo_state_mirror = Node(
        ...
        parameters=[{
            ...
            "position_command_topic": "/twin_position_controller/commands",
    ...
    # Startup sequence
    # ============================================================
    # Wait for the robot to be spawned before loading ros2_control controllers.
    ...
    # Start the direct position controller after the joint-state broadcaster has been loaded.
    position_after_jsb = RegisterEventHandler(
        OnProcessExit(
            target_action=joint_state_broadcaster,
            on_exit=[twin_position_controller],
        )
    )
    ...
    return LaunchDescription([
        SetEnvironmentVariable(
            ...
            value=(pkg_share + ":" + os.path.dirname(pkg_share)),
        ),
        SetEnvironmentVariable(
